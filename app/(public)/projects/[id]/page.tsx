  ...
  return (
    <Suspense fallback={<Loading />}>
      <main className='w-full flex justify-center p-3 bg-[#f8fafc] min-h-[85vh]'>
        <div className="w-full md:w-3/4 lg:w-3/5 xl:w-1/2 px-2 rounded-md flex flex-col gap-3 items-center">
          ...
          </div>
          {
            project.collaborators && (
              <i className="px-2 md:px-3 py-1 w-full flex gap-x-2 items-center">
                <h3 className="text-base lg:text-xl font-medium">Authors: </h3>

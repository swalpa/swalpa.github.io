      ...
      </DialogTrigger>
      {
        achievement.image && (
          <DialogContent className='w-full'>
            <div className=''>
              <img src={achievement.image} alt={achievement.statement} className='rounded-md' />
            </div>
            <div className='w-full px-3 md:px-4 lg:px-6 text-sm md:text-base text-justify' dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(achievement.statement) }} />
          </DialogContent>
        )
      }
    </Dialog>

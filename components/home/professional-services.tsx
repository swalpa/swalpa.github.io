      ...
      <div className="flex flex-col lg:flex-row px-2 gap-x-10">
        ...
        <div className="mt-7 w-full lg:w-2/3">
          ...
          <ul className="list-disc pl-7 lg:pl-10 lg:text-lg">
            <li>
              {" "}
              <b>Guest Editor</b> of special issued journal of Deep Learning for
              Predictive Modeling in Large-Scale Systems in MDPI.
            </li>
            <li>
              <b>Topic Editor</b> of the journal of Advanced Machine Learning
              Techniques for Remote Sensing Intelligent Interpretation in
              Frontiers in Remote Sensing.
            </li>
            <li>
              <b>Associate Editor</b> of journal of{" "}
              <a
                target="_blank"
                className="text-blue-500 hover:underline"
                href="https://link.springer.com/journal/42979/editors"
              >
            ...
            <li>
              <b>Advisory Member</b> in{" "}
              <a
                target="_blank"
                className="text-blue-500 hover:underline"
                href="https://www.amygdalaai.org/"
              >
                Amygdala AI
              </a>{" "}

...
const Footer = () => {
  return (
    <footer className="w-full flex flex-col gap-1 justify-center items-center bg-[#303438] text-gray-400 py-3 pt-5">
      <div className="w-full flex flex-col gap-1 justify-center items-center bg-[#303438] text-gray-400 pb-3">
        <p className="text-center text-sm">
          © 2024 Swalpa Kumar Roy. All Rights Reserved
        </p>
        <div className="text-xs text-gray-400">
          <Link
            target="_blank"
            className="hover:underline"
            href={"https://swalpa-admin.vercel.app"}
          >
            Admin Panel
          </Link>
        </div>
      ...
      <div className="w-full flex md:text-lg flex-wrap gap-3 justify-center bg-[#303438] text-white/40">
        <div className="flex gap-1 w-56 items-center">
          <div className="w-[20px] h-[20px]">
            <LucidePhone className="text-sm px-1" />
          </div>
          (+91)-9749322213
        </div>
        <div className="flex gap-1 w-56 items-center">
